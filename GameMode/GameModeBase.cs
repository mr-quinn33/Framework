...
namespace Framework.GameMode
{
    public abstract class GameModeBase : IArchitecture
    {
        ...
        public abstract Task SendCommandAsync<T>(T command, CancellationTokenSource source) where T : ICommandAsyncCancellable;
        
        public abstract Task SendCommandAsync<T>(CancellationTokenSource source) where T : ICommandAsyncCancellable, new();
        
        public abstract Task<TResult> SendCommandAsync<T, TResult>(T command, CancellationTokenSource source) where T : ICommandAsyncCancellable<TResult>;
        
        public abstract Task<TResult> SendCommandAsync<T, TResult>(CancellationTokenSource source) where T : ICommandAsyncCancellable<TResult>, new();
